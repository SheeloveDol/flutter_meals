...
final favoriteMealsProvide = StateNotifierProvider<FavoriteMealsNotifier, List<Meal>>((ref) { // told StateNotifierProvider which type of StateNotifier we are using and the type of state it manages
